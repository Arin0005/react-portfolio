...
const Projects = () => {
  return (
    <div className="border-b border-neutral-900 pb-400  ">
        <motion.h1 
        whileInView={{opacity:1,y:0}} initial={{opacity:0,y:-100}} transition={{duration:0.5}} className="my-20 text-center text-4xl">My Projects</motion.h1>
        <div className="">
            {PROJECTS.map((project, index) =>(
                <div key={index} className="mb-8 flex flex-wrap lg:justify-center">
                    ...
                    className="w-full lg:w-1/4">
                        <img src={project.image} width={200} height={100} alt={project.title} className="mb-10 rounded"/>
                    </motion.div>
